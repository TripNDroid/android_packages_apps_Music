...
public class VideoBrowserActivity extends ListActivity implements MusicUtils.Defs
{
    ...
    private static String EXTRA_ALL_VIDEO_FOLDER = "com.tripndroid.music.intent.extra.ALL_VIDEO_FOLDER";
    private static String EXTRA_ORDERBY = "com.tripndroid.music.intent.extra.VIDEO_LIST_ORDERBY";
