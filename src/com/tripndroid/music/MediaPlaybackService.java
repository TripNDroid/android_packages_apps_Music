...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.tripndroid.music.playstatechanged";
    public static final String META_CHANGED = "com.tripndroid.music.metadatachanged";
    public static final String SHUFFLE_CHANGED = "com.tripndroid.music.shuffle";
    public static final String REPEAT_CHANGED = "com.tripndroid.music.repeat";
    public static final String QUEUE_CHANGED = "com.tripndroid.music.queuechanged";
    private static final String ACTION_DELETE_MUSIC = "com.android.fileexplorer.action.DELETE_MUSIC";

    public static final String SERVICECMD = "com.tripndroid.music.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.tripndroid.music.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "com.tripndroid.music.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "com.tripndroid.music.musicservicecommand.previous";
    public static final String NEXT_ACTION = "com.tripndroid.music.musicservicecommand.next";
    public static final String EXIT_ACTION = "com.tripndroid.music.musicservicecommand.exit";
    private static final String PLAYSTATUS_REQUEST = "com.tripndroid.music.playstatusrequest";
    private static final String PLAYSTATUS_RESPONSE = "com.tripndroid.music.playstatusresponse";
    private static final String PLAYERSETTINGS_REQUEST = "com.tripndroid.music.playersettingsrequest";
    private static final String PLAYERSETTINGS_RESPONSE = "com.tripndroid.music.playersettingsresponse";
    private static final String SET_ADDRESSED_PLAYER = "com.tripndroid.music.setaddressedplayer";
    private static final String EXTRA_SHUFFLE_VAL = "shuffle";
    private static final String EXTRA_REPEAT_VAL = "repeat";
    private static final String UPDATE_WIDGET_ACTION = "com.tripndroid.music.updatewidget";
     ...
     * "com.tripndroid.music.metadatachanged"
     * "com.tripndroid.music.queuechanged",
     * "com.tripndroid.music.playbackcomplete"
     * "com.tripndroid.music.playstatechanged"
...
//            }
    ...
    private void updateNotification() {
        ...
        status1.setContentIntent(PendingIntent.getActivity(this, 0, new Intent(
                "com.tripndroid.music.PLAYBACK_VIEWER")
